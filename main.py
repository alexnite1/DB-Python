...
# по умолчанию из списка будет статья доход
...
# класс отвечающий за изменение данных
class Update(Child):
    def __init__(self):
        super().__init__()
        self.init_edit()
...
# если скрипт запущен как основная программма, то ее содержание выполнится
